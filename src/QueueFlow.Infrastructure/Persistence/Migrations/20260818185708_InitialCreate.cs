...
#pragma warning disable CA1861 // Generated migration uses inline column arrays required by the EF scaffold.
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPublicToken = table.Column<string>(type: "text", nullable: false),
                    ...
                    AttendantUserId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueCounters_OrganizationId",
                table: "QueueCounters",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Queues_PublicId",
                table: "Queues",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_OrganizationId",
                table: "QueueTickets",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_OrganizationId_QueueId_Status_Priority_Sequenc~",
                table: "QueueTickets",
                columns: new[] { "OrganizationId", "QueueId", "Status", "Priority", "SequenceNumber" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketEvents_OrganizationId",
                table: "TicketEvents",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBranches_OrganizationId",
                table: "UserBranches",
                column: "OrganizationId");
