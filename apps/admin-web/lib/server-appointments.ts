...
export type AppointmentListItem = { id: string; customerName: string; customerPhone: string | null; customerEmail: string | null; status: AppointmentStatus; scheduledStart: string; scheduledEnd: string; timeZone: string; branchId: string; branchName: string; serviceId: string; serviceName: string; createdAt: string; origin: AppointmentOrigin };
export type AppointmentDetails = AppointmentListItem & { confirmationCode: string; publicToken: string; notes: string | null; queueTicketId: string | null; createdByUserId: string | null; createdBy: string; notifications: { generated: number; pending: number; sent: number; failed: number; lastSentAt: string | null }; history: { previousStatus: AppointmentStatus; newStatus: AppointmentStatus; reason: string | null; createdAt: string }[] };
